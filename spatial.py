...
class Point():
    ...
    """
    Defines a 3d point relative to the globe (assumed spherical).
    Location specified by lat, long, altitude.
    Optional weight can be set (default 1).
    """
...
class COM():
    ...
    """
    Centre of mass object.
    Holds a list of points.
    get_com returns a Point object representing the centre of mass of constituent points. 
    """
